...
public class RadarChart : Graphic
{
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        {
            Mathf.Clamp(playerInfo.CurrentData.fame, 0, maxValue),         // 声望下限0
            Mathf.Clamp(playerInfo.CurrentData.morality, -Mathf.Infinity, maxValue), // 道德无下限
            Mathf.Clamp(playerInfo.CurrentData.intelligence, 0, maxValue),
            Mathf.Clamp(playerInfo.CurrentData.comprehension, 0, maxValue),
            Mathf.Clamp(playerInfo.CurrentData.talent, 0, maxValue),
            Mathf.Clamp(playerInfo.CurrentData.society, 0, maxValue)
        };
